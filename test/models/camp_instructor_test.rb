...
class CampInstructorTest < ActiveSupport::TestCase
  ...
  context "Within context" do
    ...
    should "not allow the same instructor to be assigned to another camp at the same time" do
      bad_assignment = FactoryBot.build(:camp_instructor, instructor: @mark, camp: @duplicatecamp)
      deny bad_assignment.valid?
